...
- **Orbit globe** — Viking MDIM 2.1 (NASA/JPL/USGS), full sphere in black space. Drag or swipe to rotate; Valles Marineris faces you at rest. The Sun, Earth, naked-eye planets, Phobos, and Deimos sit in the surrounding sky from Mars-centered geometry for that birthday, as textured globes (NASA/USGS maps, plus CC-BY Saturn/Sun wraps).
...
| Orbit-sky globes | NASA/USGS maps + [Solar System Scope](https://www.solarsystemscope.com/textures/) (CC BY 4.0) | Textured spheres for the Sun, Mercury, Venus, Earth, Jupiter, Saturn (with rings), Phobos, Deimos. See [`src/assets/planets/SOURCES.md`](src/assets/planets/SOURCES.md). |
...
NASA / JPL / USGS / ASU / MSSS **imagery is public domain**, not covered by the MIT license. Credit those agencies if you reuse the JPEGs. Solar System Scope Sun/Saturn wraps are **CC BY 4.0**. Star catalog terms stay with d3-celestial (BSD-2-Clause) and ESA Hipparcos. Cite the moon papers above if you reuse that model.
